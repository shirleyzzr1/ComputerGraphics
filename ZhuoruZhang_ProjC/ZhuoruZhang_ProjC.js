...
// look at position
var znear = 1, zfar = 30;
var g_EyeX = 0, g_EyeY = 10, g_EyeZ = 10; 
var lookX = 0, lookY = -2, lookZ = 1;
// var g_EyeX = 0, g_EyeY = 0, g_EyeZ = 10; 
...
var g_lightposx, g_lightposy, g_lightposz;
var g_ambientR, g_ambientG, g_ambientB;
var g_diffuseR, g_diffuseG, g_diffuseB;
var g_specularR,  g_specularG, g_specularB;
...
// Find new values for all time-varying parameters used for on-screen drawing
  ...
  var slider1 = document.getElementById("lightposx");
  g_lightposx = slider1.value;
  var slider2 = document.getElementById("lightposy");
  g_lightposy = slider2.value;
  var slider3 = document.getElementById("lightposz");
  g_lightposz = slider3.value;

  var slider4 = document.getElementById("ambientR");
  g_ambientR = slider4.value/100;
  var slider5 = document.getElementById("ambientG");
  g_ambientG = slider5.value/100;
  var slider6 = document.getElementById("ambientB");
  g_ambientB = slider6.value/100;

  var slider7 = document.getElementById("diffuseR");
  g_diffuseR = slider7.value/100;
  var slider8 = document.getElementById("diffuseG");
  g_diffuseG = slider8.value/100;
  var slider9 = document.getElementById("diffuseB");
  g_diffuseB = slider9.value/100;

  var slider10 = document.getElementById("specularR");
  g_specularR = slider10.value/100;
  var slider11 = document.getElementById("specularG");
  g_specularG = slider11.value/100;
  var slider12 = document.getElementById("specularB");
  g_specularB = slider12.value/100;
...
function Shadecontrol(val){
  if(val.value=="Gouraud Shading"){
    g_show1=1;
    g_show2=0;
  }
  else{
...
function Lightingcontrol(val){
  if (val.value=="Phong lighting"){
    u_isBlinn=0;
  }
  else{
    u_isBlinn=1;
...
// ALL VBObox objects.  REPLACE This with your own camera-control code.
  ...
  g_worldMat.lookAt( g_EyeX,g_EyeY,g_EyeZ, //The position of the eye point
